...
class YostLabDriver : SerialInterface {
 ...
 private:
  ...
  // commands to do compass mode
  static constexpr auto SET_GYRO_DISABLED = ":107,0\n";
  static constexpr auto SET_ACCELEROMETER_DISABLED = ":108,0\n";
  static constexpr auto SET_COMPASS_ENABLED = ":109,1\n";
  static constexpr auto SET_AXIS_DIRECTION = ":116,1\n";
  static constexpr auto SET_OVERSAMPLE_RATE = ":106,1,1,4\n";
  static constexpr auto SET_RUNNING_AVERAGE = ":117,0,0,0.5,0\n";
  // factory (0) vs singl (1) vs continuous (2) reference vector computation
  static constexpr auto SET_REFERENCE_VECTOR_MODE = ":105,2\n";
  static constexpr auto SET_COMPASS_RANGE = ":126,0\n";
  static constexpr auto SET_COMPASS_CALIBRATION_COEFFICIENTS = ":160,1.0000,0.0000,0.0000,0.0000,1.0000,0.0000,0.0000,0.0000,1.0000,0.0000,0.0000,0.0000\n";
  static constexpr auto SET_STREAMING_SLOTS_COMPASS = ":80,35,255,255,255,255,255,255,255\n";
